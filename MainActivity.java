            ...
            public void onClick(View view) {
                switch (view.getId()){
                    ...
                    case R.id.clear:
                        ...
                        break;
                    case R.id.del://sin cos tan del 수정해야함
                        inFor = inFor.substring(0, inFor.length()-2);
                    ...
                    case R.id.answer:
                        inFor += "\0";
                        operator += "=";
                        inputFormula in = new inputFormula();

                        //res = in.inputFunction(inFor);

                        //show history
                        //outLog = putLog.showHistory(operator+res);
                        //historyDisplay.append(outLog);
